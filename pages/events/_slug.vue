        ...
        <div class="page-content">
                    ...
                    <div class="content__event">
                        ...
                        <div class="content__event__action">
                            <div class="content__event__action__container">
                                <button v-if="event.reminders && !event.reminders.length" @click="showReminderModal">Set reminder</button>
                        ...
                        <div class="content__event__instincts">
                            <div class="content__event__instincts__container">
                                <div class="content__event__instincts__remind"></div>
                                <div class="content__event__instincts__share" v-if="action.share">
                                    <div class="twitter">Twitter</div>
                                    <div class="facebook">Facebook</div>
                                    <div class="whatsapp">Whatsapp</div>
                                </div>
                               
                                <div class="content__event__instincts__bookmark">
            ...
            <div class="related">
                ...
                <div class="related__body">
                    <div class="suggestion" v-for="event in similar">
